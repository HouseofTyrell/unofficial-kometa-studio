...
export const configApi = {
  ...
  create: (data: any) => request<any>('/api/configs', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id: string, data: any) => request<any>(`/api/configs/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id: string) => request<{ success: boolean }>(`/api/configs/${id}`, {
    method: 'DELETE',
  }),
...
export const profileApi = {
  ...
  create: (data: any) => request<any>('/api/profiles', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id: string, data: any) => request<any>(`/api/profiles/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id: string) => request<{ success: boolean }>(`/api/profiles/${id}`, {
    method: 'DELETE',
  }),
